...
import DifferentBg from "../assets/differentbg.webp";
import Pointing from "../assets/lady_pointing.png";
import ManElectricity from "../assets/man_electricity.png";
import ManElectricityPartner from "../assets/man_electricity_partner.webp";
  ...
  return (
    ...
    >
      ...
      <div className="static lg:absolute inset-0 flex flex-col items-center justify-center text-white">
        <div className="hidden lg:flex items-center bg-myYellow/70 text-white py-3 px-6 mt-10 w-max">
          <img src={SettingsIcon} alt="Settings" className="mr-2" />
          <p className="drop-shadow-sm normal-case font-light text-sm lg:text-[18px] w-full lg:w-auto">
