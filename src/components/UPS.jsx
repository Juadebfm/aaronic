...
const UPS = () => {
  return (
    <div className="pr-[25px] md:pr-20 lg:pr-28 h-full lg:h-[80vh] grid grid-cols-1 lg:grid-cols-2 place-content-center place-items-center gap-10 lg:gap-28 mt-8 lg:mt-0 py-16 lg:py-0">
      <div>
