  ...
  return (
    <div>
      <div className="h-full md:h-[70vh]">
        <div className="pt-[25px] md:pt-28 px-[25px] md:px-28 mt-28 pb-10 md:pb-0 flex flex-col justify-center items-center w-full">
          ...
          <h1 className="text-4xl md:text-[56px] font-bold text-center mt-10 leading-tight w-full md:w-[60%] mb-5">
            Looking for a rewarding career in the oil and gas industry?
          </h1>
          <p className="text-[18px] font-light text-center w-full md:w-[50%]">
